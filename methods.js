...
//getUserById(users, 1); // должен вывести в консоль объект юзера с id === 2
...
function removeAddresses(array) {
 const neewArr = array.filter(item => delete item.address)
 return neewArr
}
...
console.log(changePhone(users, 10, '(928)888-88-88'));